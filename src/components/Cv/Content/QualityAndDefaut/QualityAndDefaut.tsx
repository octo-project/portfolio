    ...
    <section className="content" ref={refer}>
      ...
      <div className="qualityContainer">
        <div className="qualityContent">
          ...
          <div>
            <ul>
              <li className="quality-item ">{formatText("quality1")}</li>
              <li className="quality-item">{formatText("quality2")}</li>
              <li className="quality-item">{formatText("quality3")}</li>
              <li className="quality-item">{formatText("quality4")}</li>
            </ul>
          </div>
        </div>
        <div className="defautContent">
          ...
          <div>
            <ul>
              <li className="defaut-item">{formatText("weakness1")}</li>
              <li className="defaut-item">{formatText("weakness2")}</li>
              <li className="defaut-item">{formatText("weakness3")}</li>
            </ul>
          </div>
        </div>
      </div>
